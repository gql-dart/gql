      ...
      b
        ...
        ..fields = _buildFields([
          ...
          if (enumFallbackConfig.generateFallbackValuesGlobally &&
              !enumFallbackConfig.fallbackValueMap.containsKey(node.name.value))
...
ListBuilder<Constructor> _buildConstructors() =>
    ListBuilder<Constructor>(<Constructor>[
      Constructor(
        (b) =>
            b
              ..constant = true
...
ListBuilder<Method> _buildMethods(String enumName) =>
    ListBuilder<Method>(<Method>[
      Method(
        (b) =>
            b
              ..static = true
      ...
      Method(
        (b) =>
            b
              ...
              ..body =
                  refer(
                    "_\$${toCamelCase(enumName)}ValueOf",
...
ListBuilder<Field> _buildFields(
  ...
  String enumName,
    ...
    ListBuilder<Field>(nodes.map<Field>((node) => _buildConst(node, enumName)));
