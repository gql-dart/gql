...
Class buildScalarClass(ScalarTypeDefinitionNode node) => Class(
  (b) =>
      b
        ..abstract = true
...
ListBuilder<Constructor> _buildConstructors(String scalarName) => ListBuilder(
  <Constructor>[
