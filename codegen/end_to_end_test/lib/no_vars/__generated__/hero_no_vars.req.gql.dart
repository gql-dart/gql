...
import 'package:end_to_end_test/no_vars/__generated__/hero_no_vars.ast.gql.dart' as _i2;
import 'package:end_to_end_test/no_vars/__generated__/hero_no_vars.var.gql.dart' as _i3;
...
abstract class GHeroNoVars implements Built<GHeroNoVars, GHeroNoVarsBuilder> {
  ...
  static void _initializeBuilder(GHeroNoVarsBuilder b) => b
    ..operation =
        _i1.Operation(document: _i2.document, operationName: 'HeroNoVars');
