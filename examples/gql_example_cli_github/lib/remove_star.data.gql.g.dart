...
class _$GRemoveStarData_action extends GRemoveStarData_action {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GRemoveStarData_action')
          ..add('G__typename', G__typename)
...
class GRemoveStarData_actionBuilder
  ...
  @override
  _$GRemoveStarData_action build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GRemoveStarData_action', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GRemoveStarData_action_starrable
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GRemoveStarData_action_starrable')
          ..add('G__typename', G__typename)
