...
///
/// NOTE: the actual socket connection will only get established
/// after a [Request] is handled by this [WebSocketLink].
      ...
      waitForConnectedState.listen(
        (_) {
          ...
          dataErrorComplete
              ...
              .listen((SubscriptionData message) {
            final parsedResponse = parser.parseResponse(
              message.toJson(),
            );
            if (parsedResponse.data == null && parsedResponse.errors == null) {
  ...
  Future<void> _connect() async {
    ...
    try {
      ...
      if (e is LinkException) {
        ...
        throw WebSocketLinkServerException(originalException: e);
      }
    }
  }
